  ...
  return (
    <nav className="fixed top-0 left-0  w-full flex items-center sm:hidden border-b  bg-light-secondary-1 text-main z-[60] justify-between px-5">
      ...
      <div className="relative mr-2">
        ...
        <div className={`nav-content text-dark-secondary-2 shadow-lg absolute right-0 top-16 w-48 ${toggle ? 'block' : 'hidden'} flex flex-col bg-light-secondary-1 border w-48`}>
